...
fn when_parsing_input_and_there_is_only_one_line() {
    let input_file_path = "src/bin/tests/inputs/day_4/day_four_input_example_one.txt";
...
fn when_parsing_input_and_there_are_two_lines_with_no_empty_lines() {
    let input_file_path = "src/bin/tests/inputs/day_4/day_four_input_example_two.txt";
...
fn when_parsing_input_and_there_are_four_lines_with_on_empty_line() {
    let input_file_path = "src/bin/tests/inputs/day_4/day_four_input_example_three.txt";
    let expected = vec![
...
fn when_parsing_input_and_there_are_four_passports() {
    let input_file_path = "src/bin/tests/inputs/day_4/day_four_input_example_full.txt";
    let expected = 4;
...
fn when_executing_part_two_for_valid_passports() {
    let input_file_path = "src/bin/tests/inputs/day_4/day_four_input_example_valid.txt";
    let expected = 4;
...
fn when_executing_part_two_for_invalid_passports() {
    let input_file_path = "src/bin/tests/inputs/day_4/day_four_input_example_invalid.txt";
    let expected = 0;
